...
from .views import (
    ...
    AddonCategoriesListView,
)

urlpatterns = [
    path('api/category-post/', category_post_view, name='category-post'),
    path('api/category-get/', AddonCategoriesListView.as_view(), name='category-get'),
